<template>
  <div class="automation-container">
    <div class="title-container">
      <h1 class="section-title">Alist-strm设置</h1>
    ...
    <el-card class="content-card">
      ...
      <el-table v-if="Object.keys(configs).length > 0" :data="configList" style="width: 100%">
        ...
        <el-table-column prop="address" label="Alist-strm地址" />
    ...
    <el-dialog
      ...
      title="创建Alist-strm配置"
      width="30%"
      :close-on-click-modal="false"
    >
      <el-form :model="form" label-width="120px">
        <el-form-item label="Alist-strm地址：">
          <el-input v-model="form.address" placeholder="请输入Alist-strm地址" />
        </el-form-item>
    ...
    <el-dialog
      ...
      title="编辑Alist-strm配置"
      width="30%"
      :close-on-click-modal="false"
    >
      <el-form :model="editForm" label-width="120px">
        <el-form-item label="Alist-strm地址：">
          <el-input v-model="editForm.address" placeholder="请输入Alist-strm地址" />
        </el-form-item>
        <el-form-item label="API Key：">
...
const fetchConfigs = async () => {
  try {
    const response = await axios.get('/api/alist-strm')
...
const handleCreate = async () => {
  ...
  try {
    const response = await axios.post('/api/alist-strm', form.value)
...
const handleDelete = async () => {
  ...
  try {
    await axios.delete(`/api/alist-strm/${id}`)
...
const handleUpdate = async () => {
  ...
  try {
    const response = await axios.put(`/api/alist-strm/${editForm.value.id}`, {
